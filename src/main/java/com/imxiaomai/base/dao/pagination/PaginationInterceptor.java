...
import com.imxiaomai.base.dao.dialect.Dialect;
...
//			System.out.println("sql ="+sql);
			...
			if (mappedStatement.getId().matches(paginationSqlRegEx)) {//mapper.xml里方法名带有ByPage的方法才会进入此方法
				// this.debug("matches");
				...
				if (parameterObject != null) {
					...
					paginationInfo.setTotalPage(((count - 1) / paginationInfo
							.getRecordPerPage()) + 1);
