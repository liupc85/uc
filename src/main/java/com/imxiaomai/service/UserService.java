...
public interface UserService {
	...
	@Deprecated
	public  long insert(final String mobilePhone, final String password,
			final int collegeId, final String realName,final String deviceType, final String uid, final int source)
			throws SQLException;
