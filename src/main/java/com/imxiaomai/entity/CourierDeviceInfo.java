...
public class CourierDeviceInfo extends BaseEntity{
	...
	public static CourierDeviceInfo getByDeviceIdAndMobilePhone(final String deviceId, final String mobilePhone) throws SQLException {
		return db.selectOne("where `deviceId` = ? and mobilePhone = ?", deviceId, mobilePhone);
	}
	
	private static final DBType1<CourierDeviceInfo> db = Table.courierDeviceInfo;
