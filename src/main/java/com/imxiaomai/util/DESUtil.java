...
/**
 * Created by liuxinggang on 15/7/8.
 */
...
//            DESKeySpec keySpec = new DESKeySpec(strKey.getBytes());  
            ...
            throw new RuntimeException("Error setKey. Cause: " + e);
        }
    }
    ...
    public String encryptStr(String strMing) {
        ...
        try {
            ...
            throw new RuntimeException("Error encryptStr. Cause: " + e);
        } finally {
            base64en = null ;
            byteMing = null ;
            byteMi = null ;
    ...
    public String decryptStr(String strMi) {
        ...
        try {
            ...
            throw new RuntimeException("Error decryptStr. Cause: " + e);
        } finally {
            base64De = null ;
            byteMing = null ;
            byteMi = null ;
    ...
    private byte [] encryptByte( byte [] byteS) {
        ...
        try {
            ...
            throw new RuntimeException("Error encryptByte. Cause: " + e);
        } finally {
            cipher = null ;
        }
        return byteFina;
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str1 = "/0CTkyfj4hCYLAXQH/F0QimkkmhtmH2pX54PtrdnDZ3PI+DFibbMU0vmx9Vg5Jwh6FkErTgj+WwX\r\neBjWqW0e1g==" ;
        // DES 加密字符串
